...
class FallbackToMongoIntegrationTest {
    ...
    @Test
    void whenMySqlStops_bothVersionsReadFromMongo_andWritesReturnMaintenanceMessage() {
        // Seed MySQL user
        ...
        // Baseline behavior: v1 reads MySQL, v2 reads Mongo
        ...
        // Simulate MySQL outage
        mysql.stop();

        // Now both versions should read from Mongo (fallback)
        ...
        assertThat(v1After.getBody()).contains("mongo_user").doesNotContain("mysql_user");
        assertThat(v2After.getBody()).contains("mongo_user");

        // Any write (POST/PUT/DELETE) should return 503 maintenance message. Use auth endpoint (public POST).
